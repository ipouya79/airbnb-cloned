    ...
    return (
            <div>
                ...
                <div className="mx-4">
                    ...
                    <Link to={"/account/listings/" + listing._id} key={listing._id} className="cursor-pointer flex flex-row-reverse text-right gap-4 border bg-white rounded-xl mb-2">
                        <div className="max-w-small">
                            <ListingImg listing={listing} />
                        </div>
                        <div className="flex flex-col p-4 grow rtl-direction text-right">
                            <h2 className="text-xl font-semibold"> {listing.city} || {listing.title}</h2>
