...
export default function IndexPage() {
  ...
  return (
    <div>
      ...
      <div className="grid gap-3 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 mt-8 inner rtl-direction product-card">
                ...
                <div className="flex">
                  {listing.images?.[0] && (
                    <img
                      ...
                      src={
                        "http://localhost:4000/uploads/" + listing.images?.[0]
                      }
                      alt=""
                    />
                  )}
                </div>
                <div className="p-3 product-text-container">
                  <h3 className="font-bold text-right text-large text-medium light rtl-direction mt-1">
